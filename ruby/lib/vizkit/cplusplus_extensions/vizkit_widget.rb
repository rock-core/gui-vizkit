...
UiLoader.register_3d_plugin_for('TrajectoryVisualization', "/std/vector</base/Trajectory_m>", :updateTr)
UiLoader.register_3d_plugin_for('TrajectoryVisualization', "/std/vector</base/Trajectory>", :updateTr)
