...
require File.join('vizkit','connector_objects')
require File.join('vizkit','widget_task_connector')
require File.join('vizkit','qt_orocos')
require File.join('vizkit','mime_data')
